...
class UserInteractionError {
    ...
    constructor(requestId, kind) { 
        BaseError.initialize(this, requestId, kind);UserInteractionErrorAllOf.initialize(this, kind);
        UserInteractionError.initialize(this, requestId, kind);
    }
...
UserInteractionError.RequiredProperties = ["request_id", "kind"];
